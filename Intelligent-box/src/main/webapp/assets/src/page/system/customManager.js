define(function(require, exports, module) {
    ...
    var adminCreateModalRender = template($('#tmpl-customManagerCreateModal').html());
    ...
    var adminEditModalRender = template($('#tmpl-customManagerEditModal').html());
    ...
    var ItemView = Backbone.View.extend({
        ...
        doDelete: function() {
            ...
            var txt = '确认删除帐号：[' + model.attributes.account + ']？';
