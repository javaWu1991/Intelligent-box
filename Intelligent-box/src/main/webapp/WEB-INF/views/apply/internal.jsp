...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="page-wrapper">
        ...
        <!-- screen title -->
        <c:set var="screenTitle" value="应用管理-内部应用" />
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <table id="table-app" class="datatable table table-striped table-bordered table-hover">
                        ...
                        <tbody role="items">
                            <script type="text/html" id="tmpl-appItem">
                            <td class="col-index" width="50">{{model.$index + 1}}</td>
                            <td class="col-name" width="100">
                            ...
                            <td class="col-actions" width="400">
                              ...
                              <shiro:hasPermission name="admin">
                                ...
                                <# if(model.type == 4) { #>
                                    <a  href="${contextPath}/web/system/service.htm?sid={{model.id}}">留言管理</a>
                                    <a href="${contextPath}/web/company/menu.htm?sid={{model.id}}" >菜单管理</a>
                                    <a  href="${contextPath}/web/system/serverNumber.htm?sid={{model.id}}">服务号管理</a>
                                <# }#>
                            </td>
                            </script>
                        </tbody>
...
<script>seajs.use('page/apply/internal', function(page){ page.run(); });</script>
