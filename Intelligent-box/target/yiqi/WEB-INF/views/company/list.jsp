            ...
            <form method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-5 col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="inputScale">企业规模</label>
                            <input type="text" class="form-control" id="inputScale" name="scale" placeholder="企业规模">
                        </div>
                        <div class="form-group">
                            <label for="inputContacts">企业联系人</label>
                            <input type="text" class="form-control" id="inputContacts" name="contacts" placeholder="联系人姓名">
                        </div>
                        <div class="form-group">
                            <label for="inputContactsMobile">企业联系人手机号</label>
                            <input type="text" class="form-control" id="inputContactsMobile" name="contactsMobile" placeholder="联系人手机号">
                        </div>
                        <div class="form-group">
                            <label for="inputLogo">LOGO<i class="required">*</i></label>
                            <input type="file" class="form-control" id="inputLogo" name="logoFile">
                        </div>
                        <div class="form-group">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="inputScale">企业规模</label>
                            <input type="text" class="form-control" id="inputScale" name="scale" value="{{model.scale}}" placeholder="企业规模">
                        </div>
                        <div class="form-group">
                            <label for="inputContacts">企业联系人</label>
                        ...
                        <div class="form-group">
                            <label for="inputLogo">LOGO<i class="required">*</i></label>
                            <div><img src="${contextPath}{{model.logo}}" onerror="this.parentNode.removeChild(this);" width="100" height="100" /></div>
                            <input type="file" class="form-control" id="inputLogo" name="logoFile" data-value="{{model.logo}}">
                        </div>
                    </div>
                    <div class="col-md-7 col-sm-6">
                        <div class="form-group">
